...
function buildDefaultRuntimeState() {
  const seed = {
    ...
    wires: [
      {
        ...
        from: '',
        to: '1topRed',
        fromPartPin: { partId: 'supply-1', pinId: 'connector1' },
        toPartPin: null,
        color: '#2563eb',
        width: 3.1,
        via: null,
      },
      {
        ...
        from: '',
        to: '1bottomBlue',
        fromPartPin: { partId: 'supply-1', pinId: 'connector0' },
        toPartPin: null,
        color: '#2563eb',
        width: 3.1,
        via: null,
      },
      {
        ...
        from: '',
        to: '6bottomBlue',
        fromPartPin: { partId: 'supply-2', pinId: 'connector1' },
        toPartPin: null,
        color: '#2563eb',
        width: 3.1,
        via: null,
      },
      {
        ...
        from: '',
        to: '55topBlue',
        fromPartPin: { partId: 'supply-2', pinId: 'connector0' },
        toPartPin: null,
        color: '#2563eb',
        width: 3.1,
        via: null,
      ...
      },
      {
        ...
        color: '#2563eb',
        width: 3.1,
        via: { x: 184.14328030553182, y: 151.19990810611537 },
      },
      {
        id: 'user-27',
        from: '23H',
      ...
      },
      {
        ...
        color: '#2563eb',
        width: 3.1,
        via: { x: 321.6513077995047, y: 102.04545483903911 },
      },
      {
        id: 'user-32',
        from: '42G',
      ...
      },
      {
        ...
        to: '',
        fromPartPin: null,
        toPartPin: { partId: 'supply-14', pinId: 'connector1' },
        color: '#2563eb',
        width: 3.1,
        via: null,
      },
      {
        ...
        to: '',
        fromPartPin: null,
        toPartPin: { partId: 'supply-14', pinId: 'connector0' },
        color: '#2563eb',
        width: 3.1,
        via: null,
      },
      {
        ...
        to: '',
        fromPartPin: null,
        toPartPin: { partId: 'supply-15', pinId: 'connector1' },
        color: '#2563eb',
        width: 3.1,
        via: null,
      },
      {
        ...
        from: '',
        to: '63topBlue',
        fromPartPin: { partId: 'supply-15', pinId: 'connector0' },
        toPartPin: null,
        color: '#2563eb',
        width: 3.1,
        via: null,
      },
      {
        ...
        color: '#2563eb',
        width: 3.1,
        via: { x: 541.3790344299068, y: 92.73350605003164 },
      },
      {
        id: 'user-49',
        from: '62bottomBlue',
        to: '',
        fromPartPin: null,
        toPartPin: { partId: 'meter-16', pinId: 'connector0' },
        color: '#2563eb',
        width: 3.1,
        via: null,
      },
    ...
    nextWireId: 50,
    nextPartInstanceId: 18,
    vin: 12,
    loadCurrent: 0.28,
    meterReadMode: 'voltage',
  }

  const existingPartIds = new Set(Object.keys(seed.partPlacements))
  seed.wires = seed.wires.filter((wire) => {
    const fromPartId = wire.fromPartPin?.partId
    const toPartId = wire.toPartPin?.partId
    if (fromPartId && !existingPartIds.has(fromPartId)) {
      return false
    }
    if (toPartId && !existingPartIds.has(toPartId)) {
      return false
    }
    return true
  })
